...
<body style="font-family: 'Verdana',serif; font-weight: bold; font-size: 25px; color: #4B4B62;">
    <br>
    <br>
    <p style="text-align: center; vertical-align: center;">
        ...
        An error occured. Database connection failed.
    ...
    <br><br>
    <a style="margin: 0 auto; background: black; width: 260px; display: block; text-decoration: none; color: white; padding: 5px; border-radius: 10px;" href="index.jsp"><--- Back to home</a>
